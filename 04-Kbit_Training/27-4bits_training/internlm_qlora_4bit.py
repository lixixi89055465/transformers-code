# -*- coding: utf-8 -*-
# @Time : 2025/9/29 21:28
# @Author : nanji
# @Site : 
# @File : internlm_qlora_4bit.py
# @Software: PyCharm
# @Comment :
# InternLM Lora 实战
## Step1 导入相关包
...
## Step3 数据集预处理
tokenizer = AutoTokenizer.from_pretrained("/home/nanji/workspace/Llama-2-7b-ms", trust_remote_code=True)
print(tokenizer)

tokenizer.padding_side = "right"
# 一定要设置padding_side为right，否则batch大于1时可能不收敛
...
a = tokenizer.decode( \
    model.generate(
        **ipt, \
        max_length=128, \
        do_sample=True, \
        eso_token_id=tokenizer.eos_token_id
    )[0],
