...
a=tokenizer.decode(p_model.generate(**ipt, do_sample=False,max_new_tokens=1000)[0], skip_special_tokens=True)
print(a)
# 模型合并
...
b=tokenizer.decode(p_model.generate(**ipt, do_sample=False,max_new_tokens=1000)[0], skip_special_tokens=True)
print(b)
